...
const ID = { null: "Off" };
const OdoValue = { null: "20" };
const MotorSpeed = { null: "50" };
const Soc = { null: "20" };
const batteryStates = {
  1: "Charging",
  2: "Discharging",
...
function BikeDashboard() {
  ...
  useEffect(() => {
    ...
    fetchVehicleData();
    const interval = setInterval(fetchVehicleData, 500);
  ...
  return (
    <>
      <div className="space-y-4 ps-1 pe-6 py-10">
        <div className="font-bold mb-3 text-white text-[20px]">Dashboard</div>
        <div className="flex flex-wrap mb-5 -mx-2">
          ...
          <div className="w-full md:w-5/12 px-2">
            <div className="card h-full bgshadow">
              <div className="card-body p-3 position-relative minheight-320">
                <SpeedPanel
                  speed={
                          ...
                          <tbody>
                            {vehiclePaginatedData.length > 0 ? (
                              ...
                              {ignitionStatus[fc.isWakeOrSleep] || "-"}
                                    ...
                                    <td>{MotorSpeed[fc.Motor_speed || "-"]}</td>
                                    <td>{OdoValue[fc.odoValue || "-"]}</td>
                                    <td>
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <a
                                ...
                                className="relative block w-10 h-8 rounded overflow-hidden mx-auto"
                              >
                                <video
                                  src={item.file_url}
